...
// The AI returns `assignedTo` and `mins` (natural for it to reason about).
// normalizeTask() maps them to the public schema: `assignee` + `time` string.
...
async function parseWithClaude(transcript, context = {}) {
...
// Keeps _confidence for the handler to compute uncertainParts; stripped before client response.
